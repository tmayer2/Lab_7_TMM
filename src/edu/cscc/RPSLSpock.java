 ...
 *
 * @author Todd M Mayer, October 16, 2020, CSCI 2467.
 */
public class RPSLSpock {
     ...
     *
     * @param pick
     * @return a boolean value that indicates if the pick wad valid.
     */
     ...
     * @return a boolean value that indicates if the computer won.
     */
